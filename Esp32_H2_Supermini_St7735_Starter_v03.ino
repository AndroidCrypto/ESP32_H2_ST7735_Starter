...
25.04.2025 V02 Just description changes
...
const char *PROGRAM_VERSION = "ESP32-H2 Supermini ST7735 Starter V03";
const char *PROGRAM_VERSION_SHORT = "ST7735 Starter V03";
const char *DEVICE_NAME = "ESP32-H2 Supermini   1.8 inch 128 x 160 px";
const char *DIVIDER = "---------------------";
